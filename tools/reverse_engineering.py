...
class AndroGuard(HackingTool):
    TITLE = "Androguard - Analysis of Android applications and more"
...
class Apk2Gold(HackingTool):
    TITLE = "Apk2Gold - Apk2Gold is a CLI tool for decompiling Android apps to Java"
...
class Jadx(HackingTool):
    TITLE = "JadX - Jadx is Dex to Java decompiler"
