...
class NMAP(HackingTool):
    TITLE = "NMAP - Free and open source utility for network discovery and security auditing"
...
class PhoneInfoga(HackingTool):
    TITLE = "PhoneInfoga - Advanced information gathering & OSINT framework for phone numbers"
...
class Dracnmap(HackingTool):
    TITLE = "Dracnmap - Exploit the network and gathering information with nmap help"
...
class PortScan(HackingTool):
    TITLE = "Port scanning - Port Scanning Target IP"
...
class Host2IP(HackingTool):
    TITLE = "Host to IP - Host to IP Generator"
...
class XeroSploit(HackingTool):
    TITLE = "Xerosploit - Man-in-the-middle attacks for testing purposes"
...
class RedHawk(HackingTool):
    TITLE = "RED HAWK - All In One Scanning for Information Gathering and Vulnerability Scanning"
...
class ReconSpider(HackingTool):
    TITLE = "ReconSpider - Most Advanced Open Source Intelligence (OSINT) For All Scaning"
...
class IsItDown(HackingTool):
    TITLE = "IsItDown - Check Website Is Online or Not Down/Up"
...
class Infoga(HackingTool):
    TITLE = "Infoga Email OSINT - Infoga is a tool gathering email accounts informations"
...
class ReconDog(HackingTool):
    TITLE = "ReconDog - Information Gathering Suite"
...
class Striker(HackingTool):
    TITLE = "Striker - Recon & Vulnerability Scanning Suite"
...
class Shodan(HackingTool):
    TITLE = "Find Info Using Shodan - Get ports, vulnerabilities, informations, banners,..etc"
...
class PortScannerRanger(HackingTool):
    TITLE = "Port Scanner rang3r - python script which scans in multi thread"
...
class Breacher(HackingTool):
    TITLE = "Breacher - An advanced multithreaded admin panel finder written in python"
