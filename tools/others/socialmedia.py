...
class InstaBrute(HackingTool):
    TITLE = "Instagram Attack - Brute force attack against Instagram"
...
class BruteForce(HackingTool):
    TITLE = "AllinOne SocialMedia Attack - Brute_Force_Attack Gmail Hotmail Twitter Facebook Netflix"
...
class Faceshell(HackingTool):
    TITLE = "Facebook Attack - Facebook BruteForcer"
...
class AppCheck(HackingTool):
    TITLE = "Application Checker - Tool to check if an app is installed on the target device through a link"
