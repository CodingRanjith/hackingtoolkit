...
class Keydroid(HackingTool):
    TITLE = "Keydroid - Android Keylogger + Reverse Shell"
...
class MySMS(HackingTool):
    TITLE = "MySMS - Script that generates an Android App to hack SMS"
...
class Droidcam(HackingTool):
    TITLE = "DroidCam - Powerful Tool For Grab Front Camera Snap Using A Link"
...
class EvilApp(HackingTool):
    TITLE = "EvilApp - EvilApp is a script to generate Android App "
