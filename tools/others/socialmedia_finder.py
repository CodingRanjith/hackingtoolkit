...
class FindUser(HackingTool):
    TITLE = "Find SocialMedia By UserName - Find usernames across over 75 social networks"
...
class Sherlock(HackingTool):
    TITLE = "Sherlock - Hunt down social media accounts by username across social networks"
...
class SocialScan(HackingTool):
    TITLE = "SocialScan | Username or Email - Check email address and username availability on online"
